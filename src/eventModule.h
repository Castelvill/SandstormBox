...
public:
    ...
    void controlSuperEditableText(SuperEditableTextModule * SuperEditableText, string attribute, const vector<VariableModule> & Values, vector <string> & IDs, vector<SingleFont> & FontContainer);
