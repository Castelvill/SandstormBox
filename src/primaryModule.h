...
enum EngineInstr : unsigned char{
    null, start, end_i, annotation_i, run, if_i, else_if, else_i, end_if,while_i, end_while,
    continue_i, break_i, return_i, reboot, exit_i, delete_this_event, reset_keyboard,
    dump_context_stack, dump_memory, dump_local_memory, first, last, all, random_i, index_i,
